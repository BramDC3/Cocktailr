...
import 'widgets/popular_ingredient_list_item.dart';
import 'widgets/trending_cocktail_list_item.dart';
...
class HomeScreenDesktop extends StatelessWidget {
  ...
  Future<void> _onMysteryCocktailButtonPressed(BuildContext context) async {
    ...
    Navigator.of(context).pushNamed(FluroRouter.getCocktailDetailRoute(cocktail.id));
  }
