...
class TrendingCocktailListItem extends StatelessWidget {
  ...
  void _selectCocktailAndNavigateToCocktailList(Cocktail cocktail, BuildContext context) {
    Provider.of<CocktailBloc>(context).selectCocktail(cocktail);
    ...
    BuildContext context,
      ...
      Container(
        ...
        child: Card(
          ...
          child: InkWell(
            borderRadius: BorderRadius.circular(12),
            onTap: () => _selectCocktailAndNavigateToCocktailList(cocktail, context),
            child: Column(
              children: <Widget>[
  ...
  Widget _cocktailImage(Cocktail cocktail, double height, double width) => Container(
        height: height,
        width: width,
        child: ClipRRect(
